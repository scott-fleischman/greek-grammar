...
export class App extends React.Component {
  ...
  render() {
    ...
    const groupByFunc = currentGroupIndex === undefined ? x => x.valueIndex : (x => oneOf(x.propertyValues[currentGroupIndex], 'none'));
    const groupTypeIndex = oneOf(currentGroupIndex, currentTypeIndex);
