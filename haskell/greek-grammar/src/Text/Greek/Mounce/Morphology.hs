...
getAdjectiveMismatches :: AdjectiveCategory -> [Lemma]
getAdjectiveMismatches (AdjectiveCategory _ endings lemmas) = getMismatches (adjectiveFormsLemmaSuffixes endings) lemmas
